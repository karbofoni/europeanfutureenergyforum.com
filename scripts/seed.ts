  ...
  const investors = [
    {
      ...
      summary: 'World\'s largest dedicated fund manager within greenfield renewable energy investments',
      ...
      irr_target: 12,
      tags: ['Infrastructure', 'Large-Scale', 'Offshore Wind'],
      email: '[email protected]',
      phone: '+45 70 70 51 51',
      website: 'https://www.cip.com',
      headquarters: 'Copenhagen, Denmark',
      contact_person: 'Investor Relations',
      linkedin_url: 'https://www.linkedin.com/company/copenhagen-infrastructure-partners',
    },
    {
      name: 'Omnes Capital',
      summary: 'European infrastructure investor with strong focus on renewable energy and energy transition',
      ticket_min_eur: 10000000,
      ticket_max_eur: 80000000,
      geographies: ['FR', 'ES', 'IT', 'BE', 'PT'],
      tech_focus: ['Solar', 'Wind', 'Hydro', 'Storage'],
      mandate_types: ['Equity', 'Mezz'],
      irr_target: 11,
      tags: ['Infrastructure', 'Mid-Market', 'Southern Europe'],
      email: 'contact@omnescapital.com',
      phone: '+33 1 80 48 79 00',
      website: 'https://www.omnescapital.com',
      headquarters: 'Paris, France',
      contact_person: 'Michael Pollan - Managing Partner, Renewable Energy',
      linkedin_url: 'https://www.linkedin.com/company/omnes-capital',
    },
    {
      name: 'Brookfield Renewable Partners',
      summary: 'One of the world\'s largest publicly traded renewable power platforms',
      ticket_min_eur: 100000000,
      ticket_max_eur: 1000000000,
      geographies: ['All EU', 'Global'],
      tech_focus: ['Hydro', 'Wind', 'Solar', 'Storage'],
      mandate_types: ['Equity', 'Project Finance'],
      irr_target: 10,
      tags: ['Large-Scale', 'Global', 'Operational Assets'],
      email: '[email protected]',
      phone: '+1 416 649 8172',
      website: 'https://bep.brookfield.com',
      headquarters: 'Toronto, Canada (European operations in Ireland)',
      contact_person: 'Investor Relations',
      linkedin_url: 'https://www.linkedin.com/company/brookfield-renewable',
    },
    {
